...
public class MemberTagService {
    ...
    public Long save(TagServiceCreateRequest request) {
        tagValidator.validateDuplicatedTag(request.memberId(), request.name());
    ...
    public void updateTag(Long tagId, TagServiceUpdateRequest request) {
        ...
        tag.validOwn(request.memberId(), ErrorCode.EDIT_REQUEST_IS_FORBIDDEN);
    ...
    public void deleteTag(Long id, TagServiceDeleteRequest request) {
        ...
        tag.validOwn(request.memberId(), ErrorCode.DELETE_REQUEST_IS_FORBIDDEN);
